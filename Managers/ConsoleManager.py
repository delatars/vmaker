...
class ConsoleManager:
    ...
    def args(self):
        ...
        parser.add_option("-i", dest="interactive", type="string", help="Enabling interactive mode, affects to print to stdout")
        parser.add_option("--debug", dest="mail_to", type="string", help="Enabling debug prints")
